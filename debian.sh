...
# tar -xf ~/llvm.txz -C /usr/local/bin --strip-components=2 LLVM${LLVM_VERSION#llvmorg}-Linux-X64/bin/lldb-dap LLVM${LLVM_VERSION#llvmorg}-Linux-X64/bin/lldb LLVM${LLVM_VERSION#llvmorg}-Linux-X64/bin/lldb-server
# rm ~/llvm.txz
